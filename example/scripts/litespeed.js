...
else{return obj[prop];}},set:function(obj,prop,value,receiver){obj[prop]=value;let path=receiver.__name+'.'+prop;console.log('updated',path+'.changed',receiver,obj);document.dispatchEvent(new CustomEvent(path+'.changed'));return true;},});}

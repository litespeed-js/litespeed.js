...
states[states.length++]={path:path,view:view};return this;};let match=function(location){let url=location.pathname;if(url.substr(-1)==='/'){url=url.substr(0,url.length-1);}
